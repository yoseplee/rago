...
func (d DefaultRetriever) Retrieve() error {
  ...
  "query": {
	...
	searchResult, searchErr := infra.OpenSearchClient.Search(
		func(req *opensearchapi.SearchRequest) {
			req.Index = []string{"sim-search-test"}
	...
	if err := json.NewDecoder(searchResult.Body).Decode(&openSearchResponse); err != nil {
		return err
	}
